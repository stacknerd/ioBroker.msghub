...
class IoCoreConnection {
	...
	/**
	 * Build the minimal `ui.bootstrap.about.connection` fragment for connection diagnostics.
	 *
	 * @returns {{scope:'core-link',connected:boolean,mode:'local'}} Bootstrap about connection payload.
	 */
	getBootstrapAboutConnection() {
		return {
			scope: 'core-link',
