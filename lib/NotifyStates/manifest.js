...
const manifest = Object.freeze({
	...
	options: {
		blobIntervalMs: {
			order: 10,
			type: 'number',
			label: { en: 'Full JSON interval (ms)', de: 'Full-JSON-Intervall (ms)' },
			help: {
		...
		statsMinIntervalMs: {
			order: 20,
			type: 'number',
			label: { en: 'Stats min interval (ms)', de: 'Stats Min-Intervall (ms)' },
			help: {
		...
		statsMaxIntervalMs: {
			order: 30,
			type: 'number',
			label: { en: 'Stats max interval (ms)', de: 'Stats Max-Intervall (ms)' },
			help: {
