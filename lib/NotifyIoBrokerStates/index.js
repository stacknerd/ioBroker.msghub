...
/**
 * pluginBaseObjectId Full object id of the plugin base object (e.g. `msghub.0.NotifyIoBrokerStates.0`).
 *
 * [mapTypeMarker] Overrides the marker used by `serializeWithMaps` (default: `__msghubType`).
 */

/**
 * [api] Stable API surface from MsgNotify (currently only `constants`).
 *
 * [meta] Dispatch metadata (forwarded from the producer, e.g. MsgStore).
 */
 ...
 *
 * [kind] Kind used for routing (`MsgConstants.kind` key or value).
 *
 * [level] Level used for routing (`MsgConstants.level` key or value).
 *
 * Notes:
