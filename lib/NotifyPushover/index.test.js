...
describe('NotifyPushover', () => {
	...
	it('applies kind/tag filters', async () => {
		...
		h.onNotifications(
			'due',
			[
				{ ref: 'm1', kind: 'status', level: MsgConstants.level.warning, title: 'a', text: 'x', display: { titleFullPrefix: 'w', textFullPrefix: 'w' } },
				{ ref: 'm2', kind: 'task', level: MsgConstants.level.warning, title: 'b', text: 'y', audience: { tags: ['other'] }, display: { titleFullPrefix: 'w', textFullPrefix: 'w' } },
				{
					ref: 'm3',
					kind: 'task',
					level: MsgConstants.level.warning,
