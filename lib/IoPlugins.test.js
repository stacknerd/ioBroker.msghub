			...
			const entry = {
				...
				adminUi: {
					...
					panels: [
						...
						{ id: '', title: {}, description: {}, bundle: { entry: 'a.js' } },
					],
				},
			};
			...
			const entry = {
				...
				adminUi: {
					...
					panels: [
						...
						{ id: 'presets', title: {}, description: {}, bundle: { entry: '' } },
					],
				},
			};
			const mgr = new IoPlugins(adapter, store, {
				...
				[IoPluginsCategories.ingest]: [
					{
						...
						adminUi: {
							apiVersion: '1',
							panels: [{ id: 'p', title: {}, description: {}, bundle: { entry: 'a.js' } }],
						},
					},
				],
				[IoPluginsCategories.notify]: [],
...
describe('IoPlugins — plugin i18n lifecycle', () => {
	...
	it('register rollback removes pre-registered i18n source when host registration throws', async () => {
		...
		await expect(
			mgr._registerOne({ category: IoPluginsCategories.ingest, type: 'IngestI18nTest', instanceId: 0 }),
		).to.be.rejectedWith('simulated register failure');
		expect(registry.getSourceIds()).to.not.include('plugin:IngestI18nTest:0');
	});
