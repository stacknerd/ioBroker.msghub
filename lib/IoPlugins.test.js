...
describe('IoPlugins', () => {
	...
	describe('getAdminUiContributions', () => {
		...
		it('returns panel contributions for a running plugin with adminUi', () => {
			...
			expect(c.placement).to.equal('plugin-instance');
			expect(c.order).to.equal(100);
			...
			const entry = {
				...
				adminUi: {
					...
					panels: [
						...
						{ id: '', title: {}, description: {}, placement: 'plugin-instance', order: 1, bundle: { entry: 'a.js', hash: 'h1' } },
					],
				},
			};
			...
			const entry = {
				...
				adminUi: {
					...
					panels: [
						...
						{ id: 'presets', title: {}, description: {}, placement: 'plugin-instance', order: 1, bundle: { entry: 'a.js', hash: '' } },
					],
				},
			};
			const mgr = new IoPlugins(adapter, store, {
				...
				[IoPluginsCategories.ingest]: [
					{
						...
						adminUi: {
							apiVersion: '1',
							panels: [{ id: 'p', title: {}, description: {}, placement: 'plugin-instance', order: 1, bundle: { entry: 'a.js', hash: 'h' } }],
						},
					},
				],
				[IoPluginsCategories.notify]: [],
