...
const manifest = Object.freeze({
	...
	options: {
		...
		useAltitudeFilter: {
			...
			help: {
				en: 'When enabled, only warnings whose altitude range includes your altitude are imported. Null bounds are treated as open bounds; only null/null is unbounded.',
				de: 'Wenn aktiviert, werden nur Warnungen importiert, deren Höhenbereich deine Höhenlage einschließt. Null-Grenzen gelten als offene Grenze; nur null/null ist unbegrenzt.',
			},
			default: false,
		},
		altitudeM: {
