...
/**
 * @typedef {object} MsgIngestProducerContext
 * @property {{
 ...
 * @property {object} [meta] Dispatch metadata (reason, pluginId, ...).
 */

/**
 * @typedef {object} IngestRandomDemoOptions
 * @property {number} [intervalMs=15000] Generation interval in ms.
 * @property {number} [ttlMs=120000] Base message time-to-live in ms.
 * @property {number} [ttlJitter=0.5] TTL randomization ratio (0.5 => +/- 50%).
 * @property {number} [refPoolSize=15] Size of the stable ref pool (limits concurrent demo messages).
 * @property {string} pluginBaseObjectId Full object id of the plugin base object (required, e.g. `msghub.0.IngestRandomDemo.0`).
 */
