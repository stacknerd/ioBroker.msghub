...
class IoAdminConfig {
	 ...
	 *
	 * The projection intentionally keeps ioBroker object semantics intact and only
	 * strips transport ballast such as `native`.
	 *
	...
	async _idCatalogGet(payload) {
		...
		for (const [id, obj] of Object.entries(objects || {})) {
			...
			if (obj.common && typeof obj.common === 'object' && !Array.isArray(obj.common)) {
				out.common = obj.common;
			}
			if (obj.acl && typeof obj.acl === 'object' && !Array.isArray(obj.acl)) {
				out.acl = obj.acl;
			}
