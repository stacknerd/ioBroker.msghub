		...
		if (openData && typeof openData === 'object' && !Array.isArray(openData)) {
			if (openData.profile === 'activity') {
				this._activity.nonStableSinceAt =
					typeof openData.startedAt === 'number' && Number.isFinite(openData.startedAt) ? openData.startedAt : 0;
				this._activity.startValue =
					typeof openData.startValue === 'number' && Number.isFinite(openData.startValue)
						? openData.startValue
						: NaN;
				this._activity.min = typeof openData.min === 'number' && Number.isFinite(openData.min) ? openData.min : NaN;
				this._activity.max = typeof openData.max === 'number' && Number.isFinite(openData.max) ? openData.max : NaN;
			}
