...
class ThresholdRule {
	...
	_buildDefaultText(t) {
		...
		if (this._mode === 'truthy') {
			defaultTitle = t('msghub.i18n.IngestStates.rules.threshold.title.booleanCondition.format', name);
			defaultText = t(
				pick([
			...
			defaultTitle = t('msghub.i18n.IngestStates.rules.threshold.title.outsideLimit.format', name);
			defaultText = t(
				pick([
			...
			defaultTitle = t('msghub.i18n.IngestStates.rules.threshold.title.outsideRange.format', name);
			defaultText = t(
				pick([
			...
			defaultTitle = t('msghub.i18n.IngestStates.rules.threshold.title.insideRange.format', name);
			defaultText = t(
				pick([
