...
function getThresholdPresets({ cloneTemplate, kindStatus, levelNotice }) {
	...
	}
	{
		...
		preset.message.textRecovered =
			'Der Wert war ab {{t.startedAt|datetime}} zu klein.\n' +
			'Dieser Regelverstoß wurde am {{m.state-recovered-at.val|datetime}} behoben.\n' +
	...
	}
	{
		...
		preset.message.text =
			...
			'Start: {{t.startedAt|datetime}}';
		preset.message.textRecovered =
			'Der Wert war ab {{t.startedAt|datetime}} zu groß.\n' +
			'Dieser Regelverstoß wurde am {{m.state-recovered-at.val|datetime}} behoben.\n' +
			'Diese Nachricht kann jetzt geschlossen werden.';
		preset.policy.resetOnNormal = false;
		presets.push(preset);
	...
	}
	{
		...
		preset.message.text =
			...
			'Start: {{t.startedAt|datetime}}';
		preset.message.textRecovered =
			'Der Wert lag ab {{t.startedAt|datetime}} innerhalb des unerwünschten Bereichs.\n' +
			'Dieser Regelverstoß wurde am {{m.state-recovered-at.val|datetime}} behoben.\n' +
			'Diese Nachricht kann jetzt geschlossen werden.';
		preset.policy.resetOnNormal = false;
		presets.push(preset);
	...
	}
	{
		...
		preset.message.text =
			...
			'Start: {{t.startedAt|datetime}}';
		preset.message.textRecovered =
			'Der Wert lag ab {{t.startedAt|datetime}} außerhalb des Sollbereichs.\n' +
			'Dieser Regelverstoß wurde am {{m.state-recovered-at.val|datetime}} behoben.\n' +
			'Diese Nachricht kann jetzt geschlossen werden.';
		preset.policy.resetOnNormal = false;
		presets.push(preset);
	...
	}
	{
		...
		preset.message.text =
			...
			'Start: {{t.startedAt|datetime}}';
		preset.message.textRecovered =
			'Der Wert war ab {{t.startedAt|datetime}} EIN.\n' +
			'Am {{m.state-recovered-at.val|datetime}} fiel er wieder auf AUS zurück.\n' +
			'Diese Nachricht kann jetzt geschlossen werden.';
		preset.policy.resetOnNormal = false;
		presets.push(preset);
	}
	...
	}
	{
		...
		preset.message.text =
			...
			'Start: {{t.startedAt|datetime}}';
		preset.message.textRecovered =
			'Der Wert war ab {{t.startedAt|datetime}} AUS.\n' +
			'Am {{m.state-recovered-at.val|datetime}} fiel er wieder auf EIN zurück.\n' +
			'Diese Nachricht kann jetzt geschlossen werden.';
		preset.policy.resetOnNormal = false;
		presets.push(preset);
	}
