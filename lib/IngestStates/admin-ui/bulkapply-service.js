 ...
 *   All I/O uses the same ctx handles as presets-service.js (lines 27–30).
 *
 * Business logic ported from:
 *   IoAdminTab._ingestStatesReadCustom
 *   IoAdminTab._ingestStatesBulkApplyPreview
 *   IoAdminTab._ingestStatesBulkApplyApply
 *   IoAdminTab._sanitizeIngestStatesCustom (renamed sanitizeCustom)
 *   IoAdminTab._stripManagedMeta
 *   IoAdminTab._pickManagedMeta
 *   IoAdminTab._attachManagedMeta
 *   IoAdminTab._mergeDeep (renamed mergeDeep)
 */
...
function createBulkApplyService(ctx) {
	// ── I/O handles (same as presets-service.js lines 27–30) ─────────────────
