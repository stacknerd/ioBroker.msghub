...
function IngestHue(options = {}) {
	...
	/**
	 * Build the default manual action set for Hue health messages.
	 *
	 * @returns {object[]} Message action descriptors.
	 */
	const buildDefaultActions = () => [
		{ id: 'ack', type: constants.actions.type.ack },
		{ id: 'snooze-4h', type: constants.actions.type.snooze, payload: { forMs: 4 * 60 * 60 * 1000 } },
	];
