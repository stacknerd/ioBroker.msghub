...
class IoPlugins {
	...
	/**
	 * Load backend i18n for a plugin from its `i18n/` subdirectory.
	 *
	 ...
	 * - Missing i18n directory → return null (no error; plugin runs without i18n).
