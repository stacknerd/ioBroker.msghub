...
const manifest = Object.freeze({
	...
	options: {
		includeChecked: {
			...
			help: {
				en: 'If enabled, checked list items are included in the PDF (greyed out).',
				de: 'Wenn aktiv, werden abgehakte Listeneinträge im PDF angezeigt (ausgegraut).',
			},
			default: true,
		},
		uncategorizedLabel: {
		...
		design: {
			...
			help: {
				en: 'Design preset: "screen" (lighter) or "print" (stronger lines).',
				de: 'Design-Preset: "screen" (leichter) oder "print" (kräftiger).',
			},
			default: 'screen',
		},
		notesLines: {
