...
const manifest = Object.freeze({
	...
	options: {
		audienceTagsAnyCsv: {
			...
			help: {
				en: 'Comma-separated list of tags. If set, only shopping lists with at least one of these audience.tags are included.',
				de: 'Komma-separierte Liste von Tags. Wenn gesetzt, werden nur Shoppinglisten mit mindestens einem dieser audience.tags inkludiert.',
			},
			default: '',
		},
		_headerPageSetup: {
