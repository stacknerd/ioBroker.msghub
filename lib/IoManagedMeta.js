 ...
 * IoManagedMeta
 * =============
 * Managed metadata stamping and watchlist persistence helper.
 *
 * Docs: ../docs/io/IoManagedMeta.md
 *
...
class IoManagedMeta {
	/**
	 * @param {import('@iobroker/adapter-core').AdapterInstance & { namespace: string, i18n?: ({ t?: Function, getTranslatedObject?: Function } | null), i18nBackend?: ({ t?: Function, getTranslatedObject?: Function } | null) }} adapter Adapter instance.
	...
	async _ensureWatchlistStateAsync({ category, type, instanceId }) {
		...
		const watchlistName = this._getTranslatedName(
			'msghub.i18n.core.IoManagedMeta.watchlist.name',
			category,
			type,
			instanceId,
		);
