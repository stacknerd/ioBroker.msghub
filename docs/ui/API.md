...
| `ensureAdminI18nLoaded()` | Loads `i18n/en.json` plus `i18n/<lang>.json` and merges them as `en` fallback overridden by the active language. Returns one shared promise per active language. | Browser runtime | `admin/tab/runtime.js` |
