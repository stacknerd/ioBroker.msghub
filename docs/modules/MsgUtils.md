# MsgUtils (MsgHub): shared low-level helpers

`MsgUtils` is a small collection of shared helper functions used by MsgHub’s modules.
...
- Treat this as an internal helper module (not a user-facing MsgHub API).
