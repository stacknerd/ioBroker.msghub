...
Some integrations (like `lib/NotifyIoBrokerStates/index.js`) accept **either** the key or the value, but the message model
...
- ioBroker state notifier plugin: `lib/NotifyIoBrokerStates/index.js`
