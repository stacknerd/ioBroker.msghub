...
- Registration ID (as used by `lib/IoPlugins.js`): `IngestHue:0`
...
- Base object id: `msghub.0.IngestHue.0`
- Enable switch: `msghub.0.IngestHue.0.enable`
- Status: `msghub.0.IngestHue.0.status`
